...
//---------------------------------------------------------------------------
static void Compress( const tTVPBaseBitmap *bmp, tTJSBinaryStream * out, bool is24 = false )
{
	// compress 'bmp' to 'out'.
...
//---------------------------------------------------------------------------
void SaveTLG5( tTJSBinaryStream* stream, const tTVPBaseBitmap* image, bool is24 )
{
